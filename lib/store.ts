...
export const DEFAULT_PROPERTIES: SiteProperty[] = [
  {
    ...
    policies: "Smoking outdoors only. No pets. No parties or events. Quiet hours after 10:00 PM. Visitors allowed 2:00 PM – 8:00 PM only. Please switch off lights and appliances when not in use. Extra charge for 3rd guest.",
    isActive: true,
    heroPhotoId: null,
  },
  {
    ...
    policies: "Smoking outdoors only. No pets. No parties or events. Quiet hours after 10:00 PM. Visitors allowed 2:00 PM – 8:00 PM only. Please switch off lights and appliances when not in use. Extra charge for 3rd guest in Studio. Studio max 3 guests · 2.5 BHK max 5 guests.",
    isActive: true,
    heroPhotoId: null,
  },
];
