...
export function HomePageClient({ siteData }: { siteData: SiteData }) {
  ...
  // Hero media — admin-managed URL or fallback to DB hero photo
  const heroMediaUrl = content.heroMediaUrl || heroPhotos[0]?.url || "";
  const heroMediaType = content.heroMediaType || "photo";
  const isVideo = heroMediaType === "video" || heroMediaUrl.match(/\.(mp4|webm|mov)/i);
  ...
  return (
    <div className="min-h-screen bg-[#0a0f0d]">
      ...
      <main id="main-content">
        ...
        {/* ═══════════════════════════════════════════════════════════════
            HERO — Atlantis-style full screen cinematic
        ═══════════════════════════════════════════════════════════════ */}
        <section className="relative w-full overflow-hidden" style={{ height: "100svh" }}>
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-end px-5 md:px-16 lg:px-24 pb-20 md:pb-28">
            ...
            <div className="flex items-center gap-3 mb-5 opacity-0 animate-[fadeSlideUp_0.8s_0.2s_forwards]">
              <div className="w-8 h-px bg-[#c9a84c]/60" />
              <span className="font-mono text-[#c9a84c] text-[10px] md:text-xs tracking-[0.3em] uppercase">
                Gurugram · India
              </span>
            </div>
            ...
            {/* Subtitle */}
            <p
              className="text-white/70 text-sm md:text-lg font-light leading-relaxed mb-8 max-w-sm md:max-w-md opacity-0 animate-[fadeSlideUp_0.8s_0.6s_forwards]"
            >
              Two homes in Gurugram. Book directly with your hosts — no middlemen, no hidden fees.
            </p>
          ...
          {/* Scroll indicator */}
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-1 opacity-0 animate-[fadeIn_1s_1.5s_forwards]">
            <ChevronDown size={18} className="text-white/30 animate-bounce" />
          </div>
        </section>
                    ...
                    <div className="relative h-[420px] sm:h-[500px] lg:h-[580px]">
                      ...
                      <div className="absolute inset-0 flex flex-col justify-between p-5 md:p-7">
                        <div className="flex items-start justify-between">
                          <span className="font-mono text-[#c9a84c] text-[10px] tracking-[0.3em] bg-black/40 backdrop-blur-sm px-3 py-1.5">
                            HOME {String(i + 1).padStart(2, "0")}
                          </span>
                        </div>
                        <div>
                          <h3
                            className="font-display text-white leading-tight mb-2 group-hover:text-[#c9a84c] transition-colors duration-400"
                            style={{ fontSize: "clamp(1.6rem, 3.5vw, 2.6rem)" }}
                          >
                            {p.name}
                          </h3>
                          <p className="text-white/60 text-xs md:text-sm mb-4 line-clamp-2 max-w-sm">
                            {p.vibe}
                          </p>
                          <div className="flex items-center justify-between">
                            ...
                            <span className="flex items-center gap-1.5 text-white/60 text-xs group-hover:text-[#c9a84c] group-hover:gap-2.5 transition-all duration-300">
        ...
        {/* ═══════════════════════════════════════════════════════════════
            EXPERIENCE STRIP — Horizontal scroll on mobile
        ═══════════════════════════════════════════════════════════════ */}
        <section className="bg-[#0a0f0d] py-10 md:py-16 border-t border-white/5">
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            <p className="font-mono text-[#c9a84c]/50 text-[10px] tracking-[0.4em] uppercase mb-6 text-center reveal">
              What&apos;s Included
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
              {[
                ...
                <div
                  key={title}
                  className="reveal border border-white/8 p-4 md:p-5 hover:border-[#c9a84c]/30 transition-colors duration-300 group"
                  style={{ animationDelay: `${i * 80}ms` }}
                >
                  <span className="text-2xl mb-3 block">{icon}</span>
                  <h3 className="font-display text-white text-base md:text-lg mb-1 group-hover:text-[#c9a84c] transition-colors">{title}</h3>
        ...
        <section className="bg-[#0d1a12] py-16 md:py-28 px-5 md:px-6 border-t border-white/5">
          <div className="container mx-auto max-w-3xl text-center reveal">
            <div className="w-12 h-px bg-[#c9a84c]/40 mx-auto mb-8" />
            <h2
              className="font-display text-white leading-[1.15] mb-6"
