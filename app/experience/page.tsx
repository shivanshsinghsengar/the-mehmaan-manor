        ...
        <section className="py-14 md:py-24 px-4 md:px-6 bg-[#eee9df]">
          <div className="max-w-4xl mx-auto text-center reveal">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#4caf6e] text-white font-semibold text-sm hover:bg-[#3d9d5e] transition-colors min-h-[52px]"
              >
