...
import {
  ...
  ShoppingBag, Shield, Droplets, Home, ArrowLeft, Phone, MessageCircle,
} from "lucide-react";
...
const DEFAULTS = { baseRate: 4000, weekendRate: 5000, cleaningFee: 500, maxGuests: 4, checkInTime: "14:00", checkOutTime: "11:00" };
    ...
    fetch("/api/properties")
      ...
      .then((data) => {
        if (Array.isArray(data)) {
          const p = data.find((x: any) => x.slug === "jharsa-village");
    ...
    <div className="min-h-screen bg-cream">
      ...
      <main id="main-content">
        ...
        <section className="pt-24 relative">
          <PlaceholderImage caption="PROPERTY HERO — Jharsa Village, cozy neighborhood exterior" className="w-full" aspectRatio="video" />
          <div className="absolute inset-0 bg-gradient-to-t from-ink/60 to-transparent flex items-end">
            <div className="container mx-auto px-6 pb-12">
              ...
              <p className="font-mono text-gold text-sm tracking-widest mb-2">HOME 02</p>
              <h1 className="text-4xl md:text-6xl font-display text-cream">Jharsa Village</h1>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-12">
                <div className="reveal">
                  <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
                    <div>
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="font-mono text-sm text-ink/60">593, Durga Colony, Jharsa Village, Sector 39, Gurugram</span>
                      </div>
                      <p className="font-mono text-xs text-ink/40 mb-1">28.4594° N, 77.0266° E</p>
                  ...
                  <h2 className="text-2xl font-display text-forest mb-4">Cozy Neighborhood, Close to Everything</h2>
                  <p className="text-ink/80 leading-relaxed mb-4">
                    In the heart of Jharsa Village, this home carries a neighborhood soul — warm neighbors, a local market within a two-minute walk, and that rare Gurugram commodity: genuine character.
                  </p>
                  <p className="text-ink/80 leading-relaxed">
                    The living space is intimate by design — perfect for couples, solo travelers, or a close group of two. The kitchen is modern and well-equipped. And Cyber Hub is just a short ride away.
                  </p>
                </div>
                ...
                <div className="reveal">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {["PROPERTY HERO — Jharsa Village cozy exterior","INTERIOR — Living room, warm tones","DETAIL — Local textile, brass vessel","BEDROOM — Intimate, warm lighting","KITCHEN — Modern, clean","LIFESTYLE — Coffee, light, morning calm"].map((caption, i) => (
                ...
                <div className="reveal bg-forest/5 p-6">
                  ...
                  <p className="text-sm text-ink/70">No smoking indoors. Pets negotiable. Quiet hours 10 PM – 8 AM. Please respect the neighborhood.</p>
                </div>
              </div>
                  ...
                  <div className="border-2 border-forest/10 p-6 bg-cream">
                    ...
                    <div className="space-y-3">
                      <Button asChild variant="gold" size="lg" className="w-full">
                        <a href={`https://wa.me/918828352311?text=${encodeURIComponent("Hi! I'd like to reserve Jharsa Village. Can you help me with availability?")}`} target="_blank" rel="noopener noreferrer">
      ...
      <div className={cn("lg:hidden fixed bottom-0 left-0 right-0 bg-cream border-t border-forest/10 p-4 transition-transform duration-300 z-30", stickyVisible ? "translate-y-0" : "translate-y-full")}>
        <div className="flex items-center justify-between">
          ...
          <Button asChild variant="gold" size="lg">
            <a href={`https://wa.me/918828352311?text=${encodeURIComponent("Hi! I'd like to reserve Jharsa Village.")}`} target="_blank" rel="noopener noreferrer">Reserve Now</a>
          </Button>
        </div>
      </div>
      <Footer />
